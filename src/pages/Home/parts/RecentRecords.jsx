...
// - Better spacing, typography, buttons, empty/loading states
...
export default function RecentRecords({
  ...
  const canPaginate = !loading && total > pageSize;
  ...
  const headerTitle = { fontSize: 14, fontWeight: 950, color: C.text, letterSpacing: 0.2 };
          ...
          <div style={pager}>
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 10px 18px rgba(2,6,23,0.10)";
      ...
      <div style={listWrap}>
        {loading ? (
          ...
          list.map((r) => {
            ...
            const rowStyle = {
              ...baseRow,
              borderColor: isActive ? "rgba(185,28,28,0.45)" : C.border,
              background: isActive ? "rgba(185,28,28,0.10)" : baseRow.background,
              boxShadow: isActive ? "0 14px 26px rgba(185,28,28,0.12)" : "none",
            };
